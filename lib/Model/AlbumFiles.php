 ...
 */
class AlbumFiles implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlbumFiles';
    ...
    protected static $openAPITypes = [
        'chassis' => 'string',
        'album' => '\Dinas\ShippingSdk\Model\AlbumType',
        'files' => '\SplFileObject[]'
    ];
    ...
    */
    ...
    public function setChassis($chassis)
    {
        ...
        if ((mb_strlen($chassis) > 50)) {
            throw new \InvalidArgumentException('invalid length for $chassis when calling AlbumFiles., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($chassis) < 4)) {
            throw new \InvalidArgumentException('invalid length for $chassis when calling AlbumFiles., must be bigger than or equal to 4.');
        }
     ...
     * Gets album
     *
     * @return \Dinas\ShippingSdk\Model\AlbumType|null
     */
     ...
     * Sets album
     *
     * @param \Dinas\ShippingSdk\Model\AlbumType|null $album album
     *
     * @return self
     */
     ...
     * Sets files
     *
     * @param \SplFileObject[] $files Array of photo files
     *
     * @return self
     */
    public function setFiles($files)
    {
        ...
        if ((count($files) < 1)) {
            throw new \InvalidArgumentException('invalid length for $files when calling AlbumFiles., number of items must be greater than or equal to 1.');
        }
