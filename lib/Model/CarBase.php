...
/**
 * CarBase Class Doc Comment
 *
 * @category Class
 * @description Common editable car fields
 * @package  Dinas\ShippingClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CarBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CarBase';
    ...
    */
    ...
    public function setChassis($chassis)
    {
        ...
        if ((mb_strlen($chassis) > 50)) {
            throw new \InvalidArgumentException('invalid length for $chassis when calling CarBase., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($chassis) < 4)) {
            throw new \InvalidArgumentException('invalid length for $chassis when calling CarBase., must be bigger than or equal to 4.');
        }
    ...
    public function setMake($make)
    {
        ...
        if ((mb_strlen($make) > 50)) {
            throw new \InvalidArgumentException('invalid length for $make when calling CarBase., must be smaller than or equal to 50.');
        }
    ...
    public function setModel($model)
    {
        ...
        if ((mb_strlen($model) > 50)) {
            throw new \InvalidArgumentException('invalid length for $model when calling CarBase., must be smaller than or equal to 50.');
        }
    ...
    public function setYear($year)
    {
        ...
        if (!is_null($year) && ($year < 1900)) {
            throw new \InvalidArgumentException('invalid value for $year when calling CarBase., must be bigger than or equal to 1900.');
        }
    ...
    public function setColor($color)
    {
        ...
        if (!is_null($color) && (mb_strlen($color) > 25)) {
            throw new \InvalidArgumentException('invalid length for $color when calling CarBase., must be smaller than or equal to 25.');
        }
    ...
    public function setExportType($export_type)
    {
        if (is_null($export_type)) {
            array_push($this->openAPINullablesSetToNull, 'export_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('export_type', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setExportMethod($export_method)
    {
        if (is_null($export_method)) {
            array_push($this->openAPINullablesSetToNull, 'export_method');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('export_method', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setEngineModel($engine_model)
    {
        ...
        if (!is_null($engine_model) && (mb_strlen($engine_model) > 50)) {
            throw new \InvalidArgumentException('invalid length for $engine_model when calling CarBase., must be smaller than or equal to 50.');
        }
    ...
    public function setEngineNumber($engine_number)
    {
        ...
        if (!is_null($engine_number) && (mb_strlen($engine_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $engine_number when calling CarBase., must be smaller than or equal to 50.');
        }
    ...
    public function setEngineSize($engine_size)
    {
        ...
        if (!is_null($engine_size) && ($engine_size < 0)) {
            throw new \InvalidArgumentException('invalid value for $engine_size when calling CarBase., must be bigger than or equal to 0.');
        }
    ...
    public function setEnginePower($engine_power)
    {
        ...
        if (!is_null($engine_power) && ($engine_power < 0)) {
            throw new \InvalidArgumentException('invalid value for $engine_power when calling CarBase., must be bigger than or equal to 0.');
        }
    ...
    public function setSeats($seats)
    {
        ...
        if (!is_null($seats) && ($seats > 50)) {
            throw new \InvalidArgumentException('invalid value for $seats when calling CarBase., must be smaller than or equal to 50.');
        }
        if (!is_null($seats) && ($seats < 1)) {
            throw new \InvalidArgumentException('invalid value for $seats when calling CarBase., must be bigger than or equal to 1.');
        }
    ...
    public function setCargoCapacity($cargo_capacity)
    {
        ...
        if (!is_null($cargo_capacity) && ($cargo_capacity < 0)) {
            throw new \InvalidArgumentException('invalid value for $cargo_capacity when calling CarBase., must be bigger than or equal to 0.');
        }
    ...
    public function setNetWeight($net_weight)
    {
        ...
        if (!is_null($net_weight) && ($net_weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $net_weight when calling CarBase., must be bigger than or equal to 0.');
        }
    ...
    public function setGrossWeight($gross_weight)
    {
        ...
        if (!is_null($gross_weight) && ($gross_weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $gross_weight when calling CarBase., must be bigger than or equal to 0.');
        }
    ...
    public function setLength($length)
    {
        ...
        if (!is_null($length) && ($length < 0)) {
            throw new \InvalidArgumentException('invalid value for $length when calling CarBase., must be bigger than or equal to 0.');
        }
    ...
    public function setWidth($width)
    {
        ...
        if (!is_null($width) && ($width < 0)) {
            throw new \InvalidArgumentException('invalid value for $width when calling CarBase., must be bigger than or equal to 0.');
        }
    ...
    public function setHeight($height)
    {
        ...
        if (!is_null($height) && ($height < 0)) {
            throw new \InvalidArgumentException('invalid value for $height when calling CarBase., must be bigger than or equal to 0.');
        }
    ...
    public function setPriceTerms($price_terms)
    {
        if (is_null($price_terms)) {
            array_push($this->openAPINullablesSetToNull, 'price_terms');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('price_terms', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setUnitPrice($unit_price)
    {
        ...
        if (!is_null($unit_price) && ($unit_price < 0)) {
            throw new \InvalidArgumentException('invalid value for $unit_price when calling CarBase., must be bigger than or equal to 0.');
        }
    ...
    public function setShipDateLimit($ship_date_limit)
    {
        if (is_null($ship_date_limit)) {
            array_push($this->openAPINullablesSetToNull, 'ship_date_limit');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ship_date_limit', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        if (is_null($dealer)) {
            array_push($this->openAPINullablesSetToNull, 'dealer');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('dealer', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
