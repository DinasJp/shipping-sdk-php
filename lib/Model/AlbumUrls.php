 ...
 */
class AlbumUrls implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlbumUrls';
    ...
    */
    ...
    public function setChassis($chassis)
    {
        ...
        if ((mb_strlen($chassis) > 50)) {
            throw new \InvalidArgumentException('invalid length for $chassis when calling AlbumUrls., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($chassis) < 4)) {
            throw new \InvalidArgumentException('invalid length for $chassis when calling AlbumUrls., must be bigger than or equal to 4.');
        }
    ...
    public function setUrls($urls)
    {
        ...
        if ((count($urls) < 1)) {
            throw new \InvalidArgumentException('invalid length for $urls when calling AlbumUrls., number of items must be greater than or equal to 1.');
        }
