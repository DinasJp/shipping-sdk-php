    ...
    */
    ...
    public function setChassis($chassis)
    {
        ...
        if ((mb_strlen($chassis) > 50)) {
            throw new \InvalidArgumentException('invalid length for $chassis when calling DocumentFile., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($chassis) < 4)) {
            throw new \InvalidArgumentException('invalid length for $chassis when calling DocumentFile., must be bigger than or equal to 4.');
        }
