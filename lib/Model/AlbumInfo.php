 ...
 *
 * @category Class
 * @description Photo album simple representation
 * @package  Dinas\ShippingClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class AlbumInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Album name
     *
     * @return self
     */
     ...
     * Sets count
     *
     * @param int|null $count Number of photos in album
     *
     * @return self
     */
     ...
     * Sets note
     *
     * @param string|null $note Album notes
     *
     * @return self
     */
