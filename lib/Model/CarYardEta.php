 ...
 */
class CarYardEta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CarYardEta';
    ...
    */
     ...
     * Sets chassis
     *
     * @param string|null $chassis Chassis number (or id if using numeric IDs)
     *
     * @return self
     */
